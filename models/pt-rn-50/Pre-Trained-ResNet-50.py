...
for i in range(10):
    ...
    old_layer_before = PatternNetRN50.feature_extractor[0].state_dict()['weight'].numpy()
    new_layer_before = PatternNetRN50.classifier.state_dict()['weight'].numpy()
    ...
    old_layer_after = PatternNetRN50.feature_extractor[0].state_dict()['weight'].numpy()
    new_layer_after = PatternNetRN50.classifier.state_dict()['weight'].numpy()
    ...
    torch.save(PatternNetRN50.state_dict(), f'./state-dicts/Pre-Trained-ResNet-50-{i}.pt')